...
async def get_config(settings: Settings = Depends(settings_dep)):
    ...
    return {
        ...
        "universe_exclude_base_ccy": settings.universe_exclude_base_ccy,
        "universe_exclude_symbols": settings.universe_exclude_symbols,
        "max_concurrent_requests": settings.max_concurrent_requests,
        "http_timeout_s": settings.http_timeout_s,
        "alert_lookback_hours": settings.alert_lookback_hours,
        "exit_entry_lookback_hours": settings.exit_entry_lookback_hours,
        ...
        "require_btc_trend_ok_for_entries": settings.require_btc_trend_ok_for_entries,
        "min_rank_rel_r15": settings.min_rank_rel_r15,
